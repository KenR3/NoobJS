...
// The game runs inside the event listener once the DOM is loaded
document.addEventListener('DOMContentLoaded', () => {

    // Grab all the game divs
    ...
    for (var i = 0; i < squares.length; i++) {
        ...
        // Function handles player clicks on game squares
        (function(index){
            ...
            squares[i].onclick = function() {
                ...
                if (squares[index + 7].classList.contains('taken')) {
                    ...
                    // Cannot stack on empty square
                    alert('You cannot place your token there');
                }
            }
        })(i);
    }  
    ...
    function checkBoard() {
        ...
        // Iterate every winning combination array
        for (let y = 0; y < winningArrays.length; y++) {

            // Grab the values stored in an array
    ...
    // Add eventlistener for each square that checks for game over
